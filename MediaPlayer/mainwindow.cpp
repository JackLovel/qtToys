...
void MainWindow::initUI()
{
    ...
    play_button->setIcon(QIcon(":/img/disabledPlay.svg"));
    stop_button->setIcon(QIcon(":/img/stopNormal.svg"));
    left_button->setIcon(QIcon(":/img/disabledPrevious.svg"));
    right_button->setIcon(QIcon(":/img/disabledNext.svg"));
    full_button->setIcon(QIcon(":/img/fullscreenNormal.svg"));
    sound_button->setIcon(QIcon(":/img/defaultUnmute.svg"));
...
void MainWindow::play_button_open_file()
{
    ...
    play_button->setIcon(QIcon(":/img/disabledPause.svg"));
    time->show();
...
{
    if (sound_state) {
        sound_button->setIcon(QIcon(":/img/defaultMute.svg"));
